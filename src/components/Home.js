...
class Home extends Component {
    ...
    render() {
        ...
        return(
            <div className="bg-cover h-full bg-center lg:bg-bottom" style={{backgroundImage: `url(${BigHouse})`}} id="simulation">
                <div className='flex flex-col items-start gap-16 lg:gap-20 max-w-[1400px] mx-auto pt-32 pb-32 lg:pb-60 px-5'>
                    <h1 className="text-white font-semibold text-2xl lg:text-4xl text-center" >Votre guide pour faire des économies d'énergie !</h1>
