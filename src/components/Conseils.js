    ...
    return(
        <div className="my-28 lg:my-28">
            <div className='max-w-[1400px] mx-auto px-10'>
                ...
                <p className="text-xl  text-center pt-10 pb-24">Réduire votre consommation d'énergie ne signifie pas forcément changer radicalement votre mode de vie. Avec quelques ajustements simples, vous pouvez faire des économies tout en préservant l'environnement.</p>
            
                <div className="flex flex-row justify-evenly pl-28 text-white text-center ">
                    <div className="w-[80%] relative" >
                        <img src={clim} alt="Climatiseur" className="w-[70%]"/>
                        <div className="bg-Secondary py-3 w-[70%] rounded-b-2xl absolute bottom-0 px-5">
                            <p>Comment choisir un chauffage performant et économe en énergie ?</p>
                        </div>
                    </div>
                    <div className="w-[80%] relative" >
                        <img src={voiture} alt="Climatiseur" className="w-[70%]"/>
                        <div className="bg-Secondary py-3 w-[70%] rounded-b-2xl absolute bottom-0 px-5">
                            <p>Carport solaire : Produisez votre électricité tout en protégeant votre véhicule</p>
                        </div>
                    </div>
                    <div className="w-[80%] relative" >
                        <img src={ampoule} alt="Climatiseur" className="w-[70%]"/>
                        <div className="bg-Secondary py-6 w-[70%] rounded-b-2xl absolute bottom-0 px-5">
